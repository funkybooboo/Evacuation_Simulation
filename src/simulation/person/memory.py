class Memory:
    ...
    def __init__(self):
        ...
        self.fires = set()
        self.people = set()
        self.broken_glasses = set()
        self.exit_plans = set()
        self.items = ['doors', 'exits', 'stairs', 'glasses', 'obstacles', 'walls', 'empties', 'fires', 'people', 'broken_glasses', 'exit_plans']
