    ...
    def generate_building():
        ...
        building = [
            [
                ...
                ['w','l','l','l','l','l',' ',' ','h',' ','w','s','n','s','w',' ','s',' ','w',' ',' ',' ','d','s','w'],
            ...
            [
                ['w','w','w','w','w','w','w','w','w','w','w','w','w','w','w','w','w','w','w','w','w','w','w','w','w'],
                ['w',' ',' ',' ',' ',' ','s','n','s','w','s','n','s',' ','w','l','l','l',' ','w',' ',' ','d','s','w'],
                ['w','s',' ',' ','w',' ',' ',' ',' ','w',' ',' ',' ',' ','w','l',' ',' ',' ','w',' ',' ','w','w','w'],
                ['w','l',' ',' ','w',' ','s','n','s','w','s','n','s',' ','w','l',' ',' ',' ','w',' ',' ','w'],
                ['w','l',' ',' ','w','d','w','w','w','w','w','w','w','d','w',' ',' ',' ','l','w',' ',' ','w','w','w','w','w','w','w','w','w'],
                ['w','l',' ',' ','w',' ',' ',' ',' ',' ',' ',' ',' ',' ','w',' ',' ',' ','l','w',' ',' ','d',' ',' ',' ',' ',' ',' ',' ','w'],
                ...
                ['w','n',' ',' ','w',' ',' ',' ',' ',' ',' ',' ',' ',' ','w',' ',' ',' ','l','w',' ',' ','d',' ',' ',' ',' ',' ',' ',' ','w'],
                ['w','s',' ',' ','w','d','w','w','w','w','d','w','w','w','w',' ',' ',' ','l','w',' ',' ','w','w','w','w','w','w','w','w','w'],
                ['w',' ',' ',' ','w',' ','s','n','s','w','s','n','s',' ','w','l',' ',' ','l','w',' ',' ','w'],
                ['w',' ',' ',' ','w',' ',' ',' ',' ','w',' ',' ',' ',' ','w','l',' ',' ',' ','w',' ',' ','w','w','w'],
                ['w','s','n','s','w',' ','s','n','s','w','s','n','s',' ','w','l','l','l',' ','w',' ',' ','d','s','w'],
                ['w','w','w','w','w','w','w','w','w','w','w','w','w','w','w','e','w','w','w','w','w','w','w','w','w'],
            ]
        ]
        return building
