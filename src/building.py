    ...
    def generate_building():
        ...
        building = [
            [
                ...
                ['w','l','l','l','l','l',' ',' ','h',' ','w','s','n','s','w',' ','s',' ','w','p',' ',' ',' ',' ',' ',' ',' ','p','d',' ','e'],
                ['w','l',' ',' ',' ',' ',' ',' ','h',' ','w',' ',' ',' ','w',' ','n','n','w',' ',' ',' ',' ',' ',' ',' ',' ',' ','w',' ','w'],
                ['w','l',' ','n','n','n',' ',' ','h',' ','w',' ',' ',' ','w',' ',' ',' ','w',' ',' ',' ',' ',' ',' ',' ',' ',' ','w','s','w'],
                ['w','l',' ','n','n','n',' ',' ','h',' ','w',' ',' ','p','w','p',' ','s','w',' ',' ',' ','w','w','w','w','w','w','w','w','w'],
                ['w',' ',' ',' ',' ',' ',' ',' ','h',' ','w','w','w','d','w','d','w','w','w',' ',' ',' ','h','l','n','l','w',' ',' ',' ','w'],
                ['w',' ',' ',' ',' ',' ',' ',' ','w',' ',' ',' ',' ',' ',' ',' ',' ',' ','w',' ',' ',' ','h','l','n','l','w',' ',' ',' ','w'],
                ['w','w','w',' ',' ',' ',' ',' ','w',' ','p',' ',' ',' ','p',' ',' ',' ','w',' ',' ',' ','h','l','n','l','w',' ',' ',' ','w'],
            ...
            [
                ['w','w','w','w','w','w','w','w','w','w','w','w','w','w','w','w','w','w','w','w','w','w','w','w','w','w','w','w','w','w','w'],
                ['w',' ',' ',' ',' ',' ','s','n','s','w','s','n','s',' ','w','l','l','l',' ','w','p',' ',' ',' ',' ',' ',' ','p','d',' ','w'],
                ['w','s',' ',' ','w',' ',' ',' ',' ','w',' ',' ',' ',' ','w','l',' ',' ',' ','w',' ',' ',' ',' ',' ',' ',' ',' ','w',' ','w'],
                ['w','l',' ',' ','w','p','s','n','s','w','s','n','s','p','w','l',' ',' ',' ','w',' ',' ',' ',' ',' ',' ',' ',' ','w','s','w'],
                ['w','l',' ',' ','w','d','w','w','w','w','w','w','w','d','w',' ',' ',' ','l','w',' ',' ','w','d','w','w','w','w','w','w','w'],
                ['w','l',' ',' ','w',' ',' ',' ',' ',' ',' ',' ',' ',' ','w',' ',' ',' ','l','w',' ',' ','d','p',' ',' ',' ',' ',' ',' ','w'],
                ['w','l','l','p','w',' ',' ',' ',' ','p',' ',' ',' ',' ','w','p','l','l','l','w',' ',' ','w',' ','s',' ','s',' ','s',' ','w'],
                ['w','w','w','d','w',' ','w','w','w','w','w','w','w',' ','w','d','w','w','w','w',' ',' ','w',' ','l','l','l','l','l',' ','w'],
                ['w','s','w',' ',' ',' ','w',' ',' ',' ',' ',' ','w',' ',' ',' ',' ',' ',' ',' ',' ',' ','w',' ','l','l','l','l','l',' ','w'],
                ['w',' ','w',' ',' ',' ','w',' ','s','n','s',' ','w',' ',' ',' ',' ',' ',' ',' ',' ',' ','w',' ','s',' ','s',' ','s',' ','w'],
                ['w','p','d',' ',' ',' ','d','p',' ','n',' ','p','d','p',' ',' ',' ',' ',' ',' ','p',' ','w',' ',' ',' ',' ',' ',' ',' ','w'],
                ['w',' ','w',' ',' ',' ','w',' ','s','n','s',' ','w',' ',' ',' ',' ',' ',' ',' ',' ',' ','w',' ','s',' ','s',' ','s',' ','w'],
                ['w','s','w',' ',' ',' ','w',' ',' ',' ',' ',' ','w',' ',' ',' ',' ',' ',' ',' ',' ',' ','w',' ','l','l','l','l','l',' ','w'],
                ['w','w','w','d','w',' ','w','w','w','w','w','w','w',' ','w','d','w','w','w','w',' ',' ','w',' ','l','l','l','l','l',' ','w'],
                ['w','s',' ','p','w',' ',' ',' ',' ','p',' ',' ',' ',' ','w','p','l','l','l','w',' ',' ','w',' ','s',' ','s',' ','s',' ','w'],
                ['w','n',' ',' ','w',' ',' ',' ',' ',' ',' ',' ',' ',' ','w',' ',' ',' ','l','w',' ',' ','d','p',' ',' ',' ',' ',' ',' ','w'],
                ['w','s',' ',' ','w','d','w','w','w','w','w','w','w','d','w',' ',' ',' ','l','w',' ',' ','w','d','w','w','w','w','w','w','w'],
                ['w',' ',' ',' ','w','p','s','n','s','w','s','n','s','p','w','l',' ',' ','l','w',' ',' ',' ',' ',' ',' ',' ',' ','w','s','w'],
                ['w',' ',' ',' ','w',' ',' ',' ',' ','w',' ',' ',' ',' ','w','l',' ',' ',' ','w',' ',' ',' ',' ',' ',' ',' ',' ','w',' ','w'],
                ['w','s','n','s','w',' ','s','n','s','w','s','n','s',' ','w','l','l','l',' ','w','p',' ',' ',' ',' ',' ',' ','p','d',' ','w'],
                ['w','w','w','w','w','w','w','w','w','w','w','w','w','w','w','e','w','w','w','w','w','w','w','w','w','w','w','w','w','w','w'],
            ]
            [
                ['w','w','w','w','w','w','w','w','w','w','w','w','w','w','w','w','w','w','w','w','w','w','w','w','w','w','w','w','w','w','w'],
                ['w','l','l','w',' ','n',' ','w',' ','n',' ','w',' ','s','w','s',' ','w',' ','n',' ','w',' ','n',' ','w',' ','p','d',' ','w'],
                ['w','l',' ','w',' ','n','s','w',' ','n','s','w',' ','n','w','n',' ','w','s','n',' ','w','s','n',' ','w',' ',' ','w',' ','w'],
                ['w','l',' ','w','p',' ',' ','w','p',' ',' ','w','p',' ','w',' ','p','w',' ',' ','p','w',' ',' ','p','w',' ',' ','w','s','w'],
                ['w','l',' ','w','d','w','w','w','d','w','w','w','d','w','w','w','d','w','w','w','d','w','w','w','d','w',' ',' ','w','w','w'],
                ['w','l','p','d',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ','w'],
                ['w','w','w','w',' ','p',' ',' ',' ',' ',' ',' ',' ',' ','p',' ',' ','p',' ',' ',' ',' ',' ',' ',' ',' ','p',' ',' ',' ','w'],
                ['w','s','p','d',' ',' ','w','w','w','d','w','d','w','w','w',' ',' ','w','w','w','d','w','d','w','w','w',' ','w','w','d','w'],
                ['w','n',' ','w',' ',' ','w',' ',' ','p','w','p',' ',' ','w',' ',' ','w',' ',' ','p','w','p',' ',' ','w',' ','w',' ','p','w'],
                ['w','s',' ','w',' ',' ','w',' ',' ',' ','w',' ',' ',' ','w',' ',' ','w',' ',' ',' ','w',' ',' ',' ','w',' ','w',' ','s','w'],
                ['w',' ',' ','w',' ',' ','d','p',' ',' ','w',' ',' ','p','d',' ',' ','d','p',' ',' ','w',' ',' ','p','d',' ','d','p','n','w'],
                ['w','s',' ','w',' ',' ','w',' ',' ',' ','w',' ',' ',' ','w',' ',' ','w',' ',' ',' ','w',' ',' ',' ','w',' ','w',' ','s','w'],
                ['w','n',' ','w',' ',' ','w',' ',' ','p','w','p',' ',' ','w',' ',' ','w',' ',' ','p','w','p',' ',' ','w',' ','w',' ','p','w'],
                ['w','s','p','d',' ',' ','w','w','w','d','w','d','w','w','w',' ',' ','w','w','w','d','w','d','w','w','w',' ','w','w','d','w'],
                ['w','w','w','w',' ','p',' ',' ',' ',' ',' ',' ',' ',' ','p',' ',' ','p',' ',' ',' ',' ',' ',' ',' ',' ','p',' ',' ',' ','w'],
