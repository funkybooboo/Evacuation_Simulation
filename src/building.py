    ...
    def generate_building():
        ...
        building = [
            [
                ...
                ['w','l',' ','n','n','n',' ',' ','h',' ','w',' ',' ','p','w','p',' ','m','w',' ',' ',' ','w','w','w','w','w','w','w','w','w'],
            ...
            [
                ...
                ['w','m',' ',' ','w',' ',' ',' ',' ','w',' ',' ',' ',' ','w','l',' ',' ',' ','w',' ',' ',' ',' ',' ',' ',' ',' ','w',' ','w'],
                ['w','l',' ',' ','w','p','m','n','m','w','m','n','m','p','w','l',' ',' ',' ','w',' ',' ',' ',' ',' ',' ',' ',' ','w','s','w'],
                ['w','l',' ',' ','w','d','w','w','w','w','w','w','w','d','w',' ',' ',' ','l','w',' ',' ','w','d','w','w','w','w','w','w','w'],
                ['w','l',' ',' ','w',' ',' ',' ',' ',' ',' ',' ',' ',' ','w',' ',' ',' ','l','w',' ',' ','d','p',' ',' ',' ',' ',' ',' ','w'],
                ['w','l','l','p','w',' ',' ',' ',' ','p',' ',' ',' ',' ','w','p','l','l','l','w',' ',' ','w',' ','m',' ','m',' ','m',' ','w'],
                ['w','w','w','d','w',' ','w','w','w','w','w','w','w',' ','w','d','w','w','w','w',' ',' ','w',' ','l','l','l','l','l',' ','w'],
                ['w','m','w',' ',' ',' ','w',' ',' ',' ',' ',' ','w',' ',' ',' ',' ',' ',' ',' ',' ',' ','w',' ','l','l','l','l','l',' ','w'],
                ['w',' ','w',' ',' ',' ','w',' ','m','n','m',' ','w',' ',' ',' ',' ',' ',' ',' ',' ',' ','w',' ','m',' ','m',' ','m',' ','w'],
                ['w','p','d',' ',' ',' ','d','p',' ','n',' ','p','d','p',' ',' ',' ',' ',' ',' ','p',' ','w',' ',' ',' ',' ',' ',' ',' ','w'],
                ['w',' ','w',' ',' ',' ','w',' ','m','n','m',' ','w',' ',' ',' ',' ',' ',' ',' ',' ',' ','w',' ','m',' ','m',' ','m',' ','w'],
                ['w','m','w',' ',' ',' ','w',' ',' ',' ',' ',' ','w',' ',' ',' ',' ',' ',' ',' ',' ',' ','w',' ','l','l','l','l','l',' ','w'],
                ['w','w','w','d','w',' ','w','w','w','w','w','w','w',' ','w','d','w','w','w','w',' ',' ','w',' ','l','l','l','l','l',' ','w'],
                ['w','m',' ','p','w',' ',' ',' ',' ','p',' ',' ',' ',' ','w','p','l','l','l','w',' ',' ','w',' ','m',' ','m',' ','m',' ','w'],
                ['w','n',' ',' ','w',' ',' ',' ',' ',' ',' ',' ',' ',' ','w',' ',' ',' ','l','w',' ',' ','d','p',' ',' ',' ',' ',' ',' ','w'],
                ['w','m',' ',' ','w','d','w','w','w','w','w','w','w','d','w',' ',' ',' ','l','w',' ',' ','w','d','w','w','w','w','w','w','w'],
                ['w',' ',' ',' ','w','p','m','n','m','w','m','n','m','p','w','l',' ',' ','l','w',' ',' ',' ',' ',' ',' ',' ',' ','w','s','w'],
                ['w',' ',' ',' ','w',' ',' ',' ',' ','w',' ',' ',' ',' ','w','l',' ',' ',' ','w',' ',' ',' ',' ',' ',' ',' ',' ','w',' ','w'],
            ...
            [
                ...
                ['w','l',' ','w',' ','n','m','w',' ','n','m','w',' ','n','w','n',' ','w','m','n',' ','w','m','n',' ','w',' ',' ','w',' ','w'],
